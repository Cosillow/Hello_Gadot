# THANKS: https://gist.github.com/mattogodoy/910ef7612950161f4a9871c09b62fec7
# changes: statically typed all local variables
...
var value_last: float = 0
var error_last: float = 0
var integration_stored: float = 0
